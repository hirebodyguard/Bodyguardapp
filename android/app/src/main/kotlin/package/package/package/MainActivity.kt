package com.hireabodyguard.guard
...
val launchIntent = getPackageManager().getLaunchIntentForPackage("com.hireabodyguard.guard");
if (launchIntent != null) { 
    startActivity(launchIntent);//null pointer check in case com.hireabodyguard.guard was not found
}   }
