...
//base url
String url = 'https://hireabodyguard.io/'; //add '/' at the end of the url as 'https://url.com/'
String mapkey =
    (platform == TargetPlatform.android) ? 'AIzaSyDIqkakxQ7VLplSW9V5BGrZtZ5MHZDltSU' : 'AIzaSyDIqkakxQ7VLplSW9V5BGrZtZ5MHZDltSU';
...
Future<dynamic> registerDriver() async {
  bearerToken.clear();
  dynamic result;
  ...
  try {
    ...
    print("===== Calling registerDriver() =====");
    print("device_token: $fcm");
    print("platform: $platform");
    print("myServiceId: $myServiceId");
    print("vehicletypelist: $vehicletypelist");
    print("vehicleMakeId: $vehicleMakeId");
    ...
    print("custom_make: $mycustommake");
    print("custom_model: $mycustommodel");
    print("gender: $gender");
    ...
    print("registerDriver() status: ${request.statusCode}");
    print("registerDriver() response: ${respon.body}");
    ...
    if (request.statusCode == 200) {
      ...
      var error = jsonDecode(respon.body)['errors'];
      print("422 Validation Error: $error");
      result = error[error.keys.toList()[0]]
          .toString()
          .replaceAll('[', '')
          .replaceAll(']', '');
    } else {
      print("❌ Unexpected Error: ${respon.body}");
...
geolocs.LocationSettings locationSettings = (platform == TargetPlatform.android)
    ? geolocs.AndroidSettings(
        ...
        foregroundNotificationConfig:
          ...
          notificationText:
              "HaB - Protect will continue to receive your location in background",
