...
Future<void> firebaseMessagingBackgroundHandler(RemoteMessage message) async {
  if (message.data['push_type'].toString() == 'meta-request') {
    AndroidIntent intent = AndroidIntent(
      action: 'action_view',
      package: 'com.hireabodyguard.guard', // Your app's com.hireabodyguard.guard
      componentName:
          'com.hireabodyguard.guard.MainActivity', // Replace with your app's com.hireabodyguard.guard
    );
    await intent.launch();
  }
}
