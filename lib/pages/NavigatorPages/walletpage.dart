                                                          ...
                                                          Column(
                                                            crossAxisAlignment:
                                                                CrossAxisAlignment
                                                                    .start,
                                                            children: [
                                                              walletHistory[i]['remarks'].toString()=="Money Deposited By Admin"||walletHistory[i]['remarks'].contains("Money Deposited By Admin")?MyText(
                                                                text: "Deposited By Admin",
                                                                size: media
                                                                    .width *
                                                                    fourteen,
                                                                fontweight:
                                                                ...
                                                                text: walletHistory[i]['remarks'].toString(),
                                                                size: media
                                                                    .width *
                                                                    fourteen,
                                                                fontweight:
