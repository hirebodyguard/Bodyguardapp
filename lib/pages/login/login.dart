                                                                      ...
                                                                      Container(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          decoration: InputDecoration(
                                                                              ...
                                                                              hintStyle: GoogleFonts.montserrat(fontSize: media.width * sixteen, color: hintColor)),
                                                                          style: GoogleFonts.montserrat(
                                        ...
                                        onTap: () async {
                                          ...
                                          if (newPassword == true) {
                                            ...
                                            if (mobileVerified == true) {
                                              ...
                                              }else if (proImageFile1 == null) {
                                                _error = 'Please select a profile picture to continue'; // New error message
                                              }  else {
                                                _error =
