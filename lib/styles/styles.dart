...
Color buttonColor = const Color(0xff294588);
Color theme = const Color(0xff294588);
...
Color loaderColor = const Color(0xff294588);
Color notUploadedColor = Colors.orange;
Color verifyPendingBck = const Color(0xffFEF2F2);
Color verifyPending = const Color(0xffffffff);
...
Color starColor = const Color(0xffffffff);
...
Color buttonTextColorDarkMood = const Color(0xff294588);
Color buttonTextColorLightMood = const Color(0xff294588);
